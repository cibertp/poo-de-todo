 ...
 * @author Cibert_Poet
 */
public class NumMayor extends javax.swing.JInternalFrame {
    ...
    private String numeroMayor(int a, int b){
       String msj = null;
        if(a>b){
            msj="el mayor es"+a;
        }else if(b>a){
